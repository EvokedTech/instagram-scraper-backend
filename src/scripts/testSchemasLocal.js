...
async function testSchemas() {
  try {
    ...
    const mongoUri = 'mongodb://localhost:27017/instagram-scraper-test';
    ...
    console.log('Root profile created:', {
      id: rootProfile._id,
      username: rootProfile.username,
      followers: rootProfile.apifyRawResponse.followersCount,
    ...
    console.log('Related profile created:', {
    ...
    console.log(`Found ${sessionProfiles.length} root profiles for session`);
    ...
    console.log(`Found ${depth1Profiles.length} profiles at depth 1`);
    ...
    console.log('Depth statistics:', JSON.stringify(depthStats, null, 2));
    ...
    console.log('Updated session stats:', {
      scrapedProfiles: updatedSession.stats.scrapedProfiles,
    ...
    console.log('Failed profile error stored:', failedProfile.metadata.error.message);
    ...
    console.log(`Found ${topInfluencers.length} top influencers`);

    // Test 11: Demonstrate schema structure
    console.log('\n=== Test 11: Schema Structure Demonstration ===');
    console.log('\nSession Schema Fields:');
    console.log(Object.keys(Session.schema.paths).filter(k => !k.startsWith('_')));
    
    console.log('\nRootProfileScraped Schema Fields:');
    console.log(Object.keys(RootProfileScraped.schema.paths).filter(k => !k.startsWith('_')));
    
    console.log('\nRelatedProfileScraped Schema Fields:');
    console.log(Object.keys(RelatedProfileScraped.schema.paths).filter(k => !k.startsWith('_')));
